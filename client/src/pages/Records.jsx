      ...
      <div className="p-6 space-y-6 animate-fade-in">
        ...
        {error && (
          <div className="text-center py-20">
            ...
            <button onClick={fetchData} className="px-5 py-2.5 bg-[#0F766E] text-white rounded-xl text-sm font-semibold hover:bg-[#0D6D65] transition-colors shadow-sm">Retry</button>
          </div>
        )}
